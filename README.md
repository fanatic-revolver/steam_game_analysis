Welcome to Jingyu's data analysis on steam game data!

**First to run the project you need to install the dependencies**
...
And then here is the meaning of the project:
 ...
 - LLM_Prompt.txt (The prompt I used to communicate with LLM)
 - **report.docx (For readers convenience , I put some of my findings in here)** 
 - **report.pdf (For readers convenience , I put some of my findings in here)**
 - requirements.txt (Please install the dependencies before using)
